...
// 常用模型列表
const commonModels = [
  { value: 'claude-opus-4-6', label: 'Claude Opus 4.6', color: 'violet' },
  { value: 'claude-sonnet-4-6', label: 'Claude Sonnet 4.6', color: 'indigo' },
  ...
  (newAccount) => {
    if (newAccount) {
      ...
      form.value = {
        ...
        // 稳定账户字段
        maxStableSessions: newAccount.maxStableSessions || 1,
        stableInactivityMinutes: newAccount.stableInactivityMinutes ?? 5
      }
